...
| <a name="input_breakpoint_percentile_threshold"></a> [breakpoint\_percentile\_threshold](#input\_breakpoint\_percentile\_threshold) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_buffer_size"></a> [buffer\_size](#input\_buffer\_size) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_chunking_max_tokens"></a> [chunking\_max\_tokens](#input\_chunking\_max\_tokens) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_chunking_strategy"></a> [chunking\_strategy](#input\_chunking\_strategy) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_fixed_size_chunking_configuration"></a> [fixed\_size\_chunking\_configuration](#input\_fixed\_size\_chunking\_configuration) | The S3 data source ARN for the knowledge base. | `bool` | `true` | no |
...
| <a name="input_hierarchical_chunking_configuration"></a> [hierarchical\_chunking\_configuration](#input\_hierarchical\_chunking\_configuration) | The S3 data source ARN for the knowledge base. | `bool` | `false` | no |
...
| <a name="input_lambda_arn_transformation"></a> [lambda\_arn\_transformation](#input\_lambda\_arn\_transformation) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_level_max_tokens"></a> [level\_max\_tokens](#input\_level\_max\_tokens) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_model_arn"></a> [model\_arn](#input\_model\_arn) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_overlap_percentage"></a> [overlap\_percentage](#input\_overlap\_percentage) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_overlap_tokens"></a> [overlap\_tokens](#input\_overlap\_tokens) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_parsing_prompt_string"></a> [parsing\_prompt\_string](#input\_parsing\_prompt\_string) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_parsing_strategy"></a> [parsing\_strategy](#input\_parsing\_strategy) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_s3_location_uri"></a> [s3\_location\_uri](#input\_s3\_location\_uri) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
| <a name="input_semantic_chunking_configuration"></a> [semantic\_chunking\_configuration](#input\_semantic\_chunking\_configuration) | The S3 data source ARN for the knowledge base. | `bool` | `false` | no |
| <a name="input_semantic_max_tokens"></a> [semantic\_max\_tokens](#input\_semantic\_max\_tokens) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
...
| <a name="input_step_to_apply"></a> [step\_to\_apply](#input\_step\_to\_apply) | The S3 data source ARN for the knowledge base. | `string` | `null` | no |
