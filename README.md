...
The following example creates an Agent, where you must define at a minimum the desired foundation model and the instruction for the agent.
...
You can create an Agent Alias by setting `create_agent_alias` to `true`.
